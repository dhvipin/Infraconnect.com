...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Insert into DB
    $stmt = $conn->prepare("INSERT INTO sponsors
        (firstName, middleName, lastName, companyName, gstin, companyUrl, emailId, location, state, pincode, country,
    ...
    if ($stmt->execute()) {
        ...
        header("Location: sponsorqrpage.php");
        exit;
    } else {
