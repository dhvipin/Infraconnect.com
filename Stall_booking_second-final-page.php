...
// Get the selected cluster from POST
$selected_cluster = isset($_POST['selected_cluster']) ? $_POST['selected_cluster'] : 'No Cluster Selected';
...
$selected_image = isset($clusters[$selected_cluster]) ? $clusters[$selected_cluster]['image'] : "stall-cluster.jpg";
?>
...
<!-------------------------------------------- Hero Section ------------------------------------------------------->
<!-- Page Wrapper -->
    <div class="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-5 gap-8 mt-12">
    ...
    <div class="md:col-span-2 space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-md p-4">
            <h3 class="text-lg font-semibold text-gray-800 mb-2">Updated Booking Chart</h3>
            <img src="booking-chart.jpg" alt="Booking Chart" class="rounded-lg border w-full">
        </div>

        <!-- Dynamic Stall Cluster & Pricing -->
        <div class="bg-white rounded-xl shadow-md p-4">
    ...
    <div class="md:col-span-3 bg-white p-8 rounded-xl shadow-md">
        ...
        <h1 class="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
            Choose Excellence. Reserve Your Space at <span class="text-blue-600">ICE2025</span>
        </h1>

        <p class="text-gray-700 text-base mb-4 leading-relaxed">
            Position your brand where it belongs – at the forefront of India’s infrastructure revolution.
            <strong>ICE2025</strong> offers a curated selection of premium exhibition stalls, each strategically
            placed to maximize visibility, engagement and impact.
        </p>

        <p class="text-gray-700 text-base mb-4 leading-relaxed">
            Our <span class="font-semibold">Updated Stall Booking Chart</span> is refreshed in real time, giving you
            full transparency and control to select the perfect location for your business. Whether you're seeking
            high footfall zones, anchor positions or niche engagement corners – your ideal spot is just a click
            away.
        </p>

        <p class="text-gray-700 text-base mb-4 leading-relaxed">
            This isn’t just a booking. It’s a <span class="font-semibold">bold move toward industry
                leadership</span>, brand elevation and smart investment. Exhibitors who act now secure the advantage
            – prime placement, prestige and presence.
        </p>

        <h2 class="text-xl font-semibold text-gray-800 mb-2">Why Book Now?</h2>
        <ul class="list-disc list-inside text-gray-700 mb-6">
            <li>Real-time availability ensures informed, confident decisions</li>
            <li>Strategic stall layout designed for maximum brand exposure</li>
            <li>Limited premium spots – early booking guarantees top-tier positioning</li>
            <li>Smart investment with high ROI through targeted audience engagement</li>
        </ul>

        <p class="text-lg font-semibold text-gray-800 mb-6">Make Your Brand Unmissable at ICE2025.<br>
            <span class="text-blue-600">Review the stall layout on the left. Select your ideal location. Book instantly.</span>
        </p>

        <p class="text-xl font-bold text-gray-900 mb-8">Your Brand Deserves the Spotlight – Secure Your Stall Today</p>

        <div class="text-center">
            <a href="stall_booking_final-page.html"
                class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold text-lg px-8 py-3 rounded-full shadow-lg transition">
                👉 Reserve My Stall Now
            </a>
        </div>
