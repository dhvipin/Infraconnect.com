...
<nav
    ...
    <!-- Logo -->
    <a href="#" class="mb-8">
      <img src="https://storage.googleapis.com/a1aa/image/143e8857-12bd-406b-5d46-f44b8dcbeb1c.jpg" alt="Logo"
        class="h-16 w-auto">
    </a>
...
<section class="relative max-w-full mx-auto px-6 py-32 flex flex-col items-center justify-center min-h-screen text-center text-white ">
  <main class=" rounded-xl relative flex items-center  p-6 sm:p-10 transition">
    <div class="max-w-full mx-auto">
      
      <div class="bg-[#e0e5ec] rounded-xl mt-6 max-w-4xl flex flex-col sm:flex-row overflow-hidden ">
        <div class="flex flex-col sm:flex-row w-full">
          <!-- Left Info Side -->
          <div class="flex flex-col sm:w-1/2 p-6 sm:p-8 space-y-6">
            <div class="space-y-4">
              <button class="bg-[#e0e5ec] shadow-[inset_6px_6px_12px_#c8ccd1,inset_-6px_-6px_12px_#ffffff] text-gray-800 rounded-full px-5 py-2 text-lg font-medium transition-all duration-300 hover:shadow-[inset_2px_2px_5px_#c8ccd1,inset_-2px_-2px_5px_#ffffff]">
            ...
            <div class="text-xl text-gray-700 leading-tight">
              <p class="font-semibold text-orange-600 mb-2">
                ...
                <span class="font-bold">ICE Expo 2025 – InfraConnect India</span>
              </p>
              <p class="text-[14px] leading-snug text-gray-600">
                Be part of ICE Expo 2025, India’s leading infrastructure and construction trade show, taking place at Bharat Mandapam, New Delhi. This landmark event brings together contractors, builders, interior designers, architects, civil and structural engineers, project management consultants, and real estate developers from across the country.<br><br>

                Explore cutting-edge technologies, sustainable solutions, and the latest trends shaping India’s construction and infrastructure sectors. Network with top industry leaders, discover new business opportunities, and gain insights to overcome real-world challenges in today’s dynamic construction landscape.<br><br>

                Join us at InfraConnect Expo 2025 – Connect. Collaborate. Conquer.
              </p>
            </div>
          </div>

          <!-- Right Form Side -->
          <form action="./configExhibitor.php" method="POST" class="sm:w-1/2 p-6 sm:p-8 flex flex-col space-y-6 text-xl text-gray-600">
            <input class="bg-[#e0e5ec] rounded-xl shadow-[inset_4px_4px_8px_#babecc,inset_-4px_-4px_8px_#ffffff] px-4 py-2 focus:outline-none" name="name" placeholder="Your name" required type="text" />
            <input class="bg-[#e0e5ec] rounded-xl shadow-[inset_4px_4px_8px_#babecc,inset_-4px_-4px_8px_#ffffff] px-4 py-2 focus:outline-none" name="phone" placeholder="Your phone number" required type="tel" />
            <input class="bg-[#e0e5ec] rounded-xl shadow-[inset_4px_4px_8px_#babecc,inset_-4px_-4px_8px_#ffffff] px-4 py-2 focus:outline-none" name="email" placeholder="Your email" required type="email" />
            <input class="bg-[#e0e5ec] rounded-xl shadow-[inset_4px_4px_8px_#babecc,inset_-4px_-4px_8px_#ffffff] px-4 py-2 focus:outline-none" name="company" placeholder="Your company name" type="text" />
            <input class="bg-[#e0e5ec] rounded-xl shadow-[inset_4px_4px_8px_#babecc,inset_-4px_-4px_8px_#ffffff] px-4 py-2 focus:outline-none" name="designation" placeholder="Your designation" type="text" />

            <button class="bg-[#e0e5ec] shadow-[6px_6px_12px_#c8ccd1,-6px_-6px_12px_#ffffff] text-gray-800 rounded-full px-6 py-2 text-lg font-semibold hover:shadow-[inset_2px_2px_5px_#c8ccd1,inset_-2px_-2px_5px_#ffffff] transition-all duration-300 w-32 self-center mt-4" type="submit">
              Register
            </button>
          </form>
        </div>
