...
.neu-checkbox:checked {
  ...
  /* indigo-600 */
  box-shadow:
    inset 4px 4px 8px #4f46e5,
    inset -4px -4px 8px #7c83f9;
}
...
.neu-file::-webkit-file-upload-button {
  background-color: #e0e5ec;
  border-radius: 1rem;
  box-shadow:
    4px 4px 8px #babecc,
...
.neu-file::-webkit-file-upload-button:hover {
  box-shadow:
    inset 4px 4px 8px #babecc,
    inset -4px -4px 8px #ffffff;
  background-color: #4f46e5;
...
.neu-file::file-selector-button:hover {
  box-shadow:
    inset 4px 4px 8px #babecc,
    inset -4px -4px 8px #ffffff;
  background-color: #4f46e5;
...
<body>
    ...
    <div aria-hidden="true" class="background-images">
        <img alt="Modern abstract art with vibrant colors and geometric shapes covering top left background"
            loading="lazy" src="./images/build.jpg" />
        ...
        <img alt="Creative workspace with modern tech gadgets, laptop, and coffee cup on desk covering bottom right background"
    ...
    <div class="form-wrapper mt-16 mb-10 p-16 bg-[#e0e5ec]">
        ...
        <div class="tab-buttons">
            <button class="tab  active " onclick="showForm('visitor')">Visitor</button>
            <button class="tab" onclick="showForm('exhibition')">Exhibition</button>
            <button class="tab" onclick="showForm('sponsor')">Sponsors</button>
        </div>
        <div class="forms">

            <form id="visitor" class="form-box active-form" action="configVisitor.php" action="registered_Page.php"
                method="POST" enctype="multipart/form-data">

                <h2>Visitor Form</h2>
               <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="firstName" class="block text-gray-700 font-medium mb-1">First Name <span
                                class="text-red-600">*</span></label>
                        <input type="text" id="firstName" name="firstName" placeholder="Enter First name" required
                            class="neu-input w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                    </div>
                    <div>
                        <label for="middleName" class="block text-gray-700 font-medium mb-1">Middle Name <span
                                class="text-red-600"></span></label>
                        <input type="text" id="middleName" name="middleName" placeholder="Enter Middle name"
                            class="neu-input w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                    </div>
                    <div>
                        <label for="lastName" class="block text-gray-700 font-medium mb-1">Last Name <span
                                class="text-red-600">*</span></label>
                        <input type="text" id="lastName" name="lastName" placeholder="Enter Last Name" required
                            class="neu-input w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                    </div>
                    <div>
                        <label for="designation" class="block text-gray-700 font-medium mb-1"> <span
                                class="text-red-600"></span></label>

                    </div>
                    <div>
                        <label for="companyName" class="block text-gray-700 font-medium mb-1">Company Name <span
                                class="text-red-600">*</span></label>
                        <input type="text" id="companyName" name="companyName" placeholder="Company name" required
                            class="neu-input w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                    </div>
                    <div>
                        <label for="gstin" class="block text-gray-700 font-medium mb-1">GSTIN Number</label>
                        <input type="text" id="gstin" name="gstin" placeholder="GSTIN Number"
                            pattern="^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}$"
                            title="Enter valid GSTIN number"
                            class="neu-input w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                    </div>
                    <div>
                        <label for="companyUrl" class="block text-gray-700 font-medium mb-1">Company URL</label>
                        <input type="url" id="companyUrl" name="companyUrl" placeholder="https://example.com"
                            class="neu-input w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                    </div>
                    <div>
                        <label for="emailId" class="block text-gray-700 font-medium mb-1">Email ID <span
                                class="text-red-600">*</span></label>
                        <input type="email" id="emailId" name="emailId" placeholder="your.email@example.com" required
                            class="neu-input w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                    </div>
                    <div>
                        <label for="location" class="block text-gray-700 font-medium mb-1">Registered Address (as on GST
                            Certificate)<span class="text-red-600">*</span></label>
                        <input type="text" id="location" name="location"
                            placeholder="Registered Address (as on GST Certificate)" required
                            class="neu-input w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                    </div>
                    <div>
                        <label for="state" class="block text-gray-700 font-medium mb-1">State <span
                                id="stateRequiredMark" class="text-red-600 hidden">*</span></label>
                        <select id="state" name="state" disabled
                            class="neu-input w-full border border-gray-300 rounded-md px-3 py-2 bg-gray-100 cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            <option value="">Select State</option>
                        </select>
                        <input type="text" id="stateText" name="stateText" placeholder="Enter State"
                            class="neu-input hidden w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                    </div>
                    <div>
                        <label for="pincode" class="block text-gray-700 font-medium mb-1">Pincode <span
                                class="text-red-600">*</span></label>
                        <input type="text" id="pincode" name="pincode" placeholder="Postal code" required
                            pattern="^\d{5,10}$" title="Enter valid pincode"
                            class="neu-input w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                    </div>
                    <div>
                        <label for="country" class="block text-gray-700 font-medium mb-1">Country <span
                                class="text-red-600">*</span></label>
                ...
                <div>
                    <label for="businessDescription" class="block text-gray-700 font-medium mb-1">Business Description
                        <span class="text-red-600">*</span></label>
                    <textarea id="businessDescription" name="businessDescription" rows="4"
                        placeholder="Describe your business" required
                        class="neu-input w-full border border-gray-300 rounded-md px-3 py-2 resize-y focus:outline-none focus:ring-2 focus:ring-indigo-500"></textarea>
                </div>
                <div>
                    <label for="businessProductsServices" class="block text-gray-700 font-medium mb-1">Business Products
                        Services<span class="text-red-600">*</span></label>
                    <textarea id="businessProductsServices" name="businessProductsServices" rows="4"
                        placeholder="Mention the list of products / Services you provide." required
                        class="neu-input w-full border border-gray-300 rounded-md px-3 py-2 resize-y focus:outline-none focus:ring-2 focus:ring-indigo-500"></textarea>
                </div>
                <div>
                    <label for="businessCategory" class="block text-gray-700 font-medium mb-1">Business Category <span
                            class="text-red-600">*</span></label>
                ...
                <div id="otherCategoryWrapper" class="hidden">
                    <label for="otherCategory" class="block text-gray-700 font-medium mb-1">Other Business
                        Category</label>
                    <input type="text" id="otherCategory" name="otherCategory" placeholder="Specify other category"
                        class="neu-input w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                </div>

                <div>
                    <label for="businessProducts" class="block text-gray-700 font-medium mb-1">Business Products <span
                            class="text-red-600">*</span></label>
                    <textarea id="businessProducts" name="businessProducts" rows="3"
                        placeholder="List your business products" required
                        class="neu-input w-full border border-gray-300 rounded-md px-3 py-2 resize-y focus:outline-none focus:ring-2 focus:ring-indigo-500"></textarea>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="socialEmail" class="block text-gray-700 font-medium mb-1">Email Address (associated
                            with social media accounts)</label>
                        <input type="email" id="socialEmail" name="socialEmail" placeholder="social.email@example.com"
                            class="neu-input w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                        <p class="text-gray-500 text-sm mt-1">for verification human purposes</p>
                    </div>
                    <div>
                        <label for="socialPhone" class="block text-gray-700 font-medium mb-1">Phone Number (associated
                            with social media accounts)</label>
                        <input type="tel" id="socialPhone" name="socialPhone" placeholder="+1 234 567 8900"
                            pattern="^\+?[0-9\s\-]{7,15}$" title="Enter valid phone number"
                            class="neu-input w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
                        <p class="text-gray-500 text-sm mt-1">for verification human purposes</p>
                    </div>
                </div>
                ...
                <div>
                    <label for="businessCard" class="block text-gray-700 font-medium mb-1">Business Card <span
                            class="text-red-600">*</span></label>
                    <input type="file" id="businessCard" name="businessCard" accept="image/*" required
                        class="neu-input w-full text-gray-700 file:border file:border-gray-300 file:rounded-md file:px-3 file:py-2 file:bg-white file:text-gray-700 hover:file:bg-indigo-50 cursor-pointer" />
                    <p class="text-gray-500 text-sm mt-1">Image format : JPEG, PNG . Max size : 2MB</p>
                </div>

                <div class="flex items-start space-x-3">
                    <input type="checkbox" id="consent" name="consent" required
                        class="neu-input mt-1 h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" />
                    <label for="consent" class="text-gray-700 text-sm leading-relaxed">
                        I do hereby give my consent to use my details for verification & marketing purposes as per the
                        Rudra Events private policy.<span class="text-red-600">*</span>
                    </label>
                </div>
                <div class="flex items-start space-x-1">
                    <input type="checkbox" id="consent2" name="consent2" required
                        class="neu-input mt-1 h- w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" />
                    <label for="consent" class="text-gray-700 text-sm leading-relaxed">
                        Registration Approval is subject to verification & serving by the management.<span
                            class="text-red-600">*</span>
                    </label>
                </div>

                <div class="pt-4">
                    <button type="submit" onclick="animateClick(this)"
                        class="neu-button w-full bg-[#002366] hover:bg-indigo-700 text-white font-semibold py-3 rounded-md transition duration-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                        Submit
                    </button>
                </div>
            </form>

            <form id="exhibition" class="form-box space-y-6" action="configExhibitor.php" method="POST"
            ...
            <form id="sponsor" class="form-box" action="configSponsors.php" method="POST" enctype="multipart/form-data"
                novalidate>
                <h2>Sponsor Form</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
        ...
        <footer
            ...
            <div class="mb-8 sm:mb-0 sm:w-1/3">
                ...
                <ul class="text-xs leading-5 space-y-1">
                    ...
                    <li><a href="./event_registration.php"
                            class="hover:text-indigo-400 transition">Event_Registrations</a>
                    </li>
            ...
            <div class="mb-8 sm:mb-0 sm:w-1/3">
                ...
                <img alt="Google map showing location of Hall no 6 with nearby roads and landmarks"
                    ...
                    src="https://storage.googleapis.com/a1aa/image/80d4debe-2b02-488e-6815-8fe15bdb7373.jpg"
                    width="200" />
            </div>
