...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Insert into DB
    $stmt = $conn->prepare("INSERT INTO exhibitors (firstName, middleName, lastName, companyName, gstin, companyUrl, emailId, location, state, pincode, country,
    ...
    if ($stmt->execute()) {
     ...
     // Send email
        ...
        $_SESSION['exhibition_user_id'] = $stmt->insert_id;
        header("Location: exhibitorqrpage.php");
        exit;
    } else {
