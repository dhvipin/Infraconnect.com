...
<!------------------------------------------------------- end new navbar ------------------------------------------------------>
<!-------------------------------------------- Hero Section ------------------------------------------------------->
   <div class="mt-10  max-w-6xl mx-auto px-4 py-10">
    <div class="flex flex-col md:flex-row md:space-x-10">
      <div class="md:flex-1">
        <img
          id="mainImage"
          alt="Main stall image showing a stall with three hanging lights and a maroon banner on a pale yellow wall"
          class="w-full object-contain"
          height="300"
          src="https://storage.googleapis.com/a1aa/image/d6bec831-2e84-4ac9-11da-86a852cc3312.jpg"
          width="600"
        />
        <div class=" flex space-x-4 mt-4">
          <img
            alt="Small stall image showing a stall with maroon banner and table"
            class="w-28 h-28 object-contain cursor-pointer border-2 border-transparent hover:border-blue-600"
            height="120"
            src="https://storage.googleapis.com/a1aa/image/273130a5-1058-4f68-a481-3908bbde499c.jpg"
            width="120"
            onclick="document.getElementById('mainImage').src=this.src; document.getElementById('mainImage').alt=this.alt;"
          />
          <img
            alt="Hall layout map with colored sections and text"
            class="w-28 h-28 object-contain cursor-pointer border-2 border-transparent hover:border-blue-600"
            height="120"
            src="https://storage.googleapis.com/a1aa/image/67337301-aedd-4476-4c0a-938291438491.jpg"
            width="120"
            onclick="document.getElementById('mainImage').src=this.src; document.getElementById('mainImage').alt=this.alt;"
          />
        </div>
      </div>
      <div class="bg-white md:flex-1 mt-6 md:mt-0 p-8 rounded-lg">
        <h2 class="text-lg font-normal text-gray-900">Stall Booking</h2>
        <p class="text-xs font-extrabold text-gray-900 mt-1 mb-4">
          (PLEASE SELECT YOUR STALL FROM THE BELOW LAYOUT )
        </p>
        <div class="inline-block text-sm font-bold text-red-600 mb-2">
          Stall Size:
        </div>
        <div class="text-xs font-normal">
          <table class="border-collapse border border-transparent">
            <tbody>
              <tr class="bg-[#00ffff]">
                <td class="pl-1 pr-1 font-bold text-blue-700">B.</td>
                <td class="pr-1 font-bold text-blue-700">3X3</td>
                <td class="pr-1 font-bold text-blue-700">= 129</td>
              </tr>
              <tr class="bg-[#3b82f6]">
                <td class="pl-1 pr-1 font-bold text-blue-900">C.</td>
                <td class="pr-1 font-bold text-blue-900">2X2</td>
                <td class="pr-1 font-bold text-blue-900">= 122</td>
              </tr>
              <tr class="bg-[#f87171]">
                <td class="pl-1 pr-1 font-bold text-red-700">D.</td>
                <td class="pr-1 font-bold text-red-700">2X5</td>
                <td class="pr-1 font-bold text-red-700">= 2</td>
              </tr>
              <tr class="bg-[#f472b6]">
                <td class="pl-1 pr-1 font-bold text-pink-600">E.</td>
                <td class="pr-1 font-bold text-pink-600">3X5</td>
                <td class="pr-1 font-bold text-pink-600">= 25</td>
              </tr>
              <tr class="bg-[#22c55e]">
                <td class="pl-1 pr-1 font-bold text-green-700">F.</td>
                <td class="pr-1 font-bold text-green-700">3X4</td>
                <td class="pr-1 font-bold text-green-700">=2</td>
              </tr>
              <tr class="bg-[#a78b6f]">
                <td class="pl-1 pr-1 font-bold text-gray-700">G.</td>
                <td class="pr-1 font-bold text-gray-700">2X3</td>
                <td class="pr-1 font-bold text-gray-700">=6</td>
              </tr>
            </tbody>
          </table>
        </div>
        <ul class="list-disc list-inside mt-4 text-sm text-gray-900 space-y-1">
          <li>2 Lights</li>
          <li>1 Table, 2 Chair</li>
          <li>1 Dustbin</li>
          <li>Facia Name</li>
          <li>5 AMP of Electricity (Additional Electricity chargeable)</li>
        </ul>
        <div class="mt-6 text-xs text-gray-900 max-w-xs">
          <p class="font-bold">Note:</p>
          <p>Please Book from PC / Laptop Only</p>
          <p>
            Stalls Marked in
            <span class="text-red-600 font-bold">RED</span> Are
            <span class="font-bold">BOOKED</span>
          </p>
          <p>TAP member registration compulsory</p>
        </div>
        <a
          class="mt-4 inline-block text-xs font-extrabold text-blue-900 underline"
          href="#"
          >Click to Download Hall Layout</a
        >
      </div>
    </div>
  </div>
   <div class="bg-white flex flex-col items-center py-4">
  <p class="text-center text-xs font-semibold text-gray-900 mb-2">
   Choose your stall and click on the BOOK NOW button at bottom
  </p>
  <div class="max-w-[800px] w-full overflow-auto border border-gray-300">
   <img alt="Detailed stall layout map with various colored blocks representing stalls, labeled with codes and text, showing entry points, meeting room, fire curtains, and pavilion areas" class="w-full h-auto" height="600" src="images/Expomap.png" width="800"/>
  </div>
